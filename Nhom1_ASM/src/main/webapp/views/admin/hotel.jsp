	...
	<div id="wrapper">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="ps-3 pe-3">
					<div class="w-100"
						style="background-color: #3959AB; border-radius: 15px; height: auto; margin-top: 30px;">
						<nav class="navbar">
							<div class="container-fluid">
								...
								<form class="d-flex" role="search" style="margin-right: 50px;">
									<input class="form-control me-2" style="width: 400px"
										type="search" placeholder="Nhập tên khách sạn hoặc khu vực"
								...
								<tbody>
									<c:forEach var="hotel" items="${hotels}">
										<tr>
											...
											<td>${hotel.city}</td>
											<td>${hotel.status}</td>
											<td><a href="/admin/hotel-form/edit/${hotel.hotelid}"
								...
								<ul class="pagination">
									<c:if test="${totalPages > 1}">
										...
										<li class="page-item"><a class="page-link"
											href="/admin/hotel?page=0&keyword=${keyword}"
										...
										<c:forEach
											...
											<c:if test="${i < totalPages}">
												<li class="page-item ${currentPage == i ? 'active' : ''}">
													<a class="page-link"
													href="/admin/hotel?page=${i}&keyword=${keyword}">${i + 1}</a>
												</li>
											</c:if>
										</c:forEach>
										...
										<!-- Trang cuối cùng -->
										<li class="page-item"><a class="page-link"
											href="/admin/hotel?page=${totalPages - 1}&keyword=${keyword}">Last</a></li>
									</c:if>
								</ul>
							</div>
						...
						<div class="row">
							<div class="col pb-3">
								<a href="/admin/hotel-form"
									class="btn btn-danger float-end me-4">Thêm mới</a> <a
									href="/admin/hotel"
