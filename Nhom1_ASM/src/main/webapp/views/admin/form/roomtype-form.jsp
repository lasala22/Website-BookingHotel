...
<script src="https://kit.fontawesome.com/e2b57de48e.js"
	crossorigin="anonymous"></script>
<title>RoomType Management Form</title>
</head>
<body id="page-top">
	<div id="wrapper">
		<!-- Sidebar -->
				...
				<div class="ps-3 pe-3">
					<div class="w-100" style="height: auto;">
						...
						<div class="row p-4 m-4 mt-4"
							...
							<form:form class="row g-3" action="/admin/roomtype/save"
								modelAttribute="roomtype" enctype="multipart/form-data">
								<div class="col-md-6">
									<label for="typeID" class="form-label fw-bold">Type ID:</label>
									<form:input class="form-control" path="typeid" />
								</div>
								<div class="col-md-6">
									<label for="typeName" class="form-label fw-bold">Type
										Name: </label>
									<form:input class="form-control" path="typeName" />
								</div>
								<div class="col-md-4">
									<label for="inputPrice" class="form-label fw-bold">Price:
									</label>
									<form:input class="form-control" path="price" />
								</div>
								<div class="col-md-4">
									<label for="inputState" class="form-label fw-bold">Capacity</label><br>
									<form:radiobuttons path="capacity" items="${capacities}"
