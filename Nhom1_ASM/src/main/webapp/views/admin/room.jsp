			...
			<div id="content">
				...
				<div class="ps-3 pe-3">
					<div class="w-100"
							...
							<div class="container-fluid">
								...
								<form class="d-flex" role="search" style="margin-right: 50px;">
									<input class="form-control me-2" style="width: 400px"
										type="search" placeholder="Nhập loại phòng hoặc tên khách sạn"
									...
									<c:forEach var="room" items="${rooms}">
										<tr>
											...
											<td><a type="button" class="btn btn-primary btn-sm"
												href="/admin/room/edit/${room.roomID}"> Edit </a>
										</tr>
									</c:forEach>
								</tbody>
							</table>
								...
								<ul class="pagination">
									<c:if test="${totalPages > 1}">
										...
										<li class="page-item"><a class="page-link"
											href="/admin/room?page=0&keyword=${keyword}"
										...
										<c:forEach
											...
											<c:if test="${i < totalPages}">
												<li class="page-item ${currentPage == i ? 'active' : ''}">
													<a class="page-link"
													href="/admin/room?page=${i}&keyword=${keyword}">${i + 1}</a>
												</li>
											</c:if>
										</c:forEach>
										...
										<!-- Trang cuối cùng -->
										<li class="page-item"><a class="page-link"
											href="/admin/room?page=${totalPages - 1}&keyword=${keyword}">Last</a></li>
									</c:if>
								</ul>
							</div>
						</div>
						<div class="row">
							<div class="col">
								<a class="btn btn-danger float-end me-4" href="/admin/room-form">Thêm
									mới</a> <a href="/admin/room"
