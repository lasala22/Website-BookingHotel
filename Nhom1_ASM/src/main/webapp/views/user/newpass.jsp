...
<body>
	<div class="container">
		...
		<div class="row">
			<div class="col-8"></div>
			<div class="col-4 p-4"
				style="height: 500px; background-color: white; border-radius: 15px; border: 1px solid gray;">
				<form action="/newpass" class="form" method="post">
					<h3>Quên Mật Khẩu</h3>
					<div class="mb-2">
						<b><i>${error}</i></b>
						<b><i>${error1}</i></b>
					...
					<!-- <label for="" class="form-label mt-4">Email</label> <input
						...
						href="#" style="font-size: 14px;"> Quay về trang chủ? </a>
					<br>
					<div class="row">
